...
import bodyBg from '../assets/bg.svg';
...
const artData = {
	art_works: [
		...
		},
		{
			...
			narrative:
				'This weight of inner pain and silent struggles we carry. Yet, within the sorrow, there’s a quiet resilience, a strength that comes from enduring hardship.',
...
export const loadImgs = () => {
  ...
  `;
	...
	// bodyElement.innerHTML += bgTemplate;
};
